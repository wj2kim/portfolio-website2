...
/** welcome section */
export const name = "Paul WooJung Kim";
...
export const myWords = {
  ...
  koreanQuote: "자바스크립트를 사용하여<br/>개발하는 것을 좋아하고<br/>효율적인 프로세스와<br/>좋은 UI/UX에 욕심이<br/>있는 개발자 입니다."
}
...
/** skills section */
export const skillIntro = "I love making web interactive.<br/> These are the skills I am experienced with.";
